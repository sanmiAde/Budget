...
class UserAdapter(context: Context) : RecyclerView.Adapter<UserAdapter.ViewHolder>()  {
    ...
    inner class ViewHolder(val userListBinding: UserListItemBinding) : RecyclerView.ViewHolder(userListBinding.root)
}